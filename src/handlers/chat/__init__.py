...
from src.handlers.chat.chat_pinned_mess_handler import router as chat_pinned_mess_router

chat_combined_router = Router()

chat_combined_router.include_routers(
    chat_booking_router, chat_member_router, chat_cancel_router, chat_pinned_mess_router
)